...
def mambo_init():
    ...
    mamboAdd = "D0:3A:EE:30:E6:20" #Vicon Object ->  Mambo_KeyboardControlled
    #mamboAdd = "E0:14:A0:AE:3D:C7" #Vicon Object ->  Mambo_Autonomous 
    wifi = False
    retries = 12
...
#Init ROS node + Vicon
    ...
    s1_vicon = rospy.Subscriber('/vicon/Mambo_KeyboardControlled/Mambo_KeyboardControlled', TransformStamped, cb_vicon_data1, buff_size=1)
    s3_vicon = rospy.Subscriber('/vicon/SUMO_11_5_2018/SUMO_11_5_2018/', TransformStamped, cb_vicon_data3, buff_size=1)
    s2_vicon = rospy.Subscriber('/vicon/Mambo_Autonomous/Mambo_Autonomous', TransformStamped, cb_vicon_data2, buff_size=1)
